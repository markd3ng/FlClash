...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static String m25(value) => "Осталось: ${value}";

  static String m26(count) => "Осталось ${count}";

  static String m27(seconds) => "Повтор через ${seconds} с";
