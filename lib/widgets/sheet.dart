...
class _AdaptiveSheetScaffoldState extends State<AdaptiveSheetScaffold> {
  ...
  Widget build(BuildContext context) {
    ...
    final type = widget.type ?? sheetProvider?.type ?? SheetType.page;
    ...
    final actions = widget.actions.map<Widget>((action) {
      if (action is IconButtonData) {
        return buildIconButton(action);
      }
